...
startOrientation1 = p.getQuaternionFromEuler([0,0,yaw1_rad])
startOrientation2 = p.getQuaternionFromEuler([0,0,yaw2_rad])

boxId1 = p.loadURDF("racecar/racecar.urdf",pos1, startOrientation1)
boxId2 = p.loadURDF("racecar/racecar.urdf",pos2, startOrientation2)
...
model1 = simulation_model.AccidentSimulator()
out = model1(torch.randn(1, 8, 3, 224, 224), "This is a test text")
out = out[0]  # shape: torch.Size([1, 1200, 2])
out # : torch.Size([1200, 2])
